...
exports.seed = async function(knex) {
	...
	let componentId = await knex.raw(`SELECT id FROM fn_get_module_descendants(?) WHERE name = ? AND type = 'middleware'`, [parentId, 'DataProcessorManager']);
