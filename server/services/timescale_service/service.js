 ...
 * @classdesc The Plant.Works Web Application Server Timescale db Service.
 *
 * @description
 * Allows the rest of the Plant.Works Modules to store / retrieve data in the TimescaleDb.
 *
 */
class TimescaleService extends PlantWorksBaseService {
	// #region Constructor
	 ...
	 *
	 * @summary  Logs off from the connection to the configured TimescaleDb Server.
	 */
	async _teardown() {
		try {
			if(!this.$database)
...
exports.service = TimescaleService;
