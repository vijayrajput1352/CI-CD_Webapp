 ...
 *
 * @description
 * Allows the rest of the Plant.Works Modules to communicate with each other by allowing registration / invocation of API.
 *
 */
class ApiService extends PlantWorksBaseService {
	// #region Constructor
