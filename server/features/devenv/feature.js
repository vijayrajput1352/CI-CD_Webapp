 ...
 * @classdesc The Plant.Works Web Application Server IDE feature - single-point access for all feature development artifacts the Tenant/User combination has access to.
 *
 *
 */
class Devenv extends PlantWorksBaseFeature {
	// #region Constructor
	 ...
	 *
	 * @summary  Everyone with the devenv-access permission gets to see this icon.
	 */
	async getDashboardDisplayDetails(ctxt) { // eslint-disable-line no-unused-vars
		try {
			...
			mainDisplay['attributes']['name'] = 'Devenv';
			mainDisplay['attributes']['route'] = 'devenv';
			mainDisplay['attributes']['icon_type'] = 'md';
			mainDisplay['attributes']['icon_path'] = 'developer-board';
	 ...
	 * @param    {object} ctxt - Koa context.
	 *
	 * @returns  {object} IDE display stuff for this Feature.
	 *
	 * @summary  No display in the development environment itself.
	 */
