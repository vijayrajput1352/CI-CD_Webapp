 ...
 * @classdesc The Plant.Works Web Application Server Config feature - single-point access for all feature configs the Tenant/User combination has access to.
 *
 *
 */
class Configure extends PlantWorksBaseFeature {
	// #region Constructor
	 ...
	 *
	 * @summary  Everyone with the config-access permission gets to see this icon.
	 */
	async getDashboardDisplayDetails(ctxt) { // eslint-disable-line no-unused-vars
		try {
			...
			mainDisplay['attributes']['name'] = 'Configure';
			mainDisplay['attributes']['route'] = 'configure';
			mainDisplay['attributes']['icon_type'] = 'fa';
			mainDisplay['attributes']['icon_path'] = 'plug';
