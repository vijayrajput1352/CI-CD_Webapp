...
class Main extends PlantWorksBaseComponent {
	...
	async _getTenantGroupTree(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error retrieving tenant group tree`, err);
		}
	}
	...
	async _getPossibleTenantUsersList(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error retrieving possible tenant users for a group`, err);
		}
	}
	...
	async _getTenantGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error retrieving tenant group`, err);
		}
	}
	...
	async _addTenantGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error adding tenant group`, err);
		}
	}
	...
	async _updateTenantGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error updating tenant group`, err);
		}
	}
	...
	async _deleteTenantGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error deleting tenant group`, err);
		}
	}
	...
	async _getTenantUserGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error retrieving tenant user group`, err);
		}
	}
	...
	async _addTenantUserGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error adding tenant user to group`, err);
		}
	}
	...
	async _deleteTenantUserGroup(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error deleting tenant user from group`, err);
		}
	}
	...
	async _addTenantGroupPermission(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error adding permission to group`, err);
		}
	}
	...
	async _deleteTenantGroupPermission(ctxt) {
		try {
			...
			throw new PlantWorksComponentError(`Error deleting permission from group`, err);
		}
	}
	// #endregion
