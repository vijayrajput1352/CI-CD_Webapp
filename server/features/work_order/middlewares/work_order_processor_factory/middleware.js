...
/**
 * @class   WorkOrderProcessorFactory
 * @extends {PlantWorksBaseMiddleware}
 * @classdesc The Plant.Works Webapp Server workorder Processor Factory middleware - manager parsing and evalution of external master data files.
 *
 *
 */
class WorkOrderProcessorFactory extends PlantWorksBaseMiddleware {
	constructor(module) {
		super(module);
	}
	 ...
	 * @override
	 * @instance
	 * @memberof WorkOrderProcessorFactory
	 * @name     _setup
	 *
	 * @returns  {undefined} Nothing.
	 *
	 * @summary  create in memory cache to store workorder file processors.
	 */
	async _setup() {
		try {
			await super._setup();
...
exports.middleware = WorkOrderProcessorFactory;
