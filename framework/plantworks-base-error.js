 ...
 */
/**
 * @class PlantWorksBaseError
 * @extends {Error}
 * @classdesc   The Plant.Works Server Base Class for all errors
 *
 ...
 */
class PlantWorksBaseError extends Error {
	...
	toString() {
		...
		if(!this.$innerError.toString || !(typeof this.$innerError.toString === 'function') || !(this.$innerError.$innerError))
	...
	toJSON() {
		...
		if(!(this.$innerError instanceof PlantWorksBaseError)) {
...
exports.PlantWorksBaseError = PlantWorksBaseError;
